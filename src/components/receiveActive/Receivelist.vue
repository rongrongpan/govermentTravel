<template>
    <div class="receivelist">
        <div class="retire-title"><img src="@/assets/tabbar3.png" alt="">小型多样化活动</div>
        <div class="search">
            <div class="retiretitle-left">
                <router-link :to="{name:'activeList'}" style="margin-right:10px;">
                    <el-button size="small" type="primary" style="width:120px;">活动记录</el-button>
                </router-link>
       ...
       <Testpop testType='6' :id="testPopId" :centerDialogVisible="centerDialog" v-on:changeCom="changeParent"/>
        ...
        <UpFile :centerDialogVisible="centerDialogVisible" @changeFile="changeFile" :type="7" :activeId="pagelistinfo"/>
    </div>
</template>
<script>
import $ from 'jquery';
...
export default {
    ...
    methods:{
        ...
        getGrouplist(){
            ...
            api.getPackageActive({street:this.streetValue}).then(res=>{
