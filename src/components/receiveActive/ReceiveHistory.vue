<template>
    <div class="count-data">
        <div class="xqname">小型多样化活动 /<span> 活动记录</span></div>
        <div class="search">
            <div class="leftwra">
                <p class="title-list">活动记录</p>
...
export default {
    ...
    methods:{
        ...
        getList(pageNum){
            ...
            this.downLink = this.$store.state.baseUrl+'/excel/orderexport?orderStatus='+this.typeValue+'&personally='+this.getAuto+'&createTime='+valueDate+'&orderType=12';
            api.getPackageListActive({
