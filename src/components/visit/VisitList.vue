<template>
    <div class="retirement">
        <div class="retire-title"><img src="@/assets/tabbar6.png" alt="">病人探望</div>
        <div class="search">
            <div class="retiretitle-left">
                <el-button  type="primary" size="small" @click="centerDialog = true">创建探望安排</el-button>
        ...
        <Testpop testType='3' :centerDialogVisible="centerDialog" v-on:changeCom="changeParent"/>
